...
public class MainActivity1 extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		clickedOn = (TextView) findViewById(R.id.clickedOn);
	...
	private void setFlipperImage(final int res) {
		...
		Picasso.with(MainActivity1.this).load(pic.get(res).toString()) //
				.into(image);
			...
			public void onClick(View v) {
				...
				if (swipe.swipeDetected()) {
					if (swipe.getAction() == SwipeDetector.Action.LR) {
						...
						viewFlipper.setInAnimation(MainActivity1.this,
								R.anim.slide_in_left);
						viewFlipper.setOutAnimation(MainActivity1.this,
								R.anim.slide_out_right);
	...
	public void deletePhoto(String photoId) {
		 ...
		 */
		Prefrences.showLoadingDialog(MainActivity1.this, "Loading...");
		AsyncHttpClient client = new AsyncHttpClient();

		client.addHeader("Content-type", "application/json");
		client.addHeader("Accept", "application/json");

		client.delete(MainActivity1.this,
